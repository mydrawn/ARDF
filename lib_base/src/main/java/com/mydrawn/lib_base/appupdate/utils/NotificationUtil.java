...
public final class NotificationUtil {
    ...
    private static void afterO(NotificationManager manager) {
        ...
        if (channel == null) {
            ...
            channel = new NotificationChannel(com.mydrawn.lib_base.appupdate.utils.Constant.DEFAULT_CHANNEL_ID, com.mydrawn.lib_base.appupdate.utils.Constant.DEFAULT_CHANNEL_NAME,
...
//            channel.enableVibration(true);
    ...
    private static String getNotificationChannelId() {
        ...
        if (channel == null) {
            return com.mydrawn.lib_base.appupdate.utils.Constant.DEFAULT_CHANNEL_ID;
        }
